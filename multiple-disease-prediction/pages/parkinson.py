...
parkinsons_csv_path = os.path.abspath(os.path.join(working_dir, "..", "dataset", "parkinsons.csv"))
...
pickle.dump(model, open(parkinsons_model_path, 'wb'))
print("Model saved successfully!")

# Load the saved model
loaded_model = pickle.load(open(parkinsons_model_path, 'rb'))
